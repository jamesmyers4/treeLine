...
Then authenticated crawling (`--login-url`/`--username`/
...
Capture-layer groundwork for API test scaffolding was built and verified
against the same real authenticated OpenEMR target: opt-in redacted
